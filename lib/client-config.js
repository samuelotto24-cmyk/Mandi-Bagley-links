...
- No emojis unless she's already using one.`,
  ...
  // only — never auto-grown from sends. Empty until seeded via
  // `node ~/seed-voice-samples.js mandi-bagley`. Stored in Redis once seeded;
  // this array is the static fallback if Redis is empty.
  voiceSamples: [],
