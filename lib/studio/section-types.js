...
export const SECTION_TYPES = {
  ...
  recipe: {
    ...
    fields: [
      ...
      { key: 'intro',        label: 'One-line intro',   placeholder: 'Sunday-morning energy.', aiExpandable: true },
    ...
    aiPrompt: `Write a one-line recipe intro (under 14 words) that sets the mood — when she'd make it, what it tastes like. Match her voice exactly. No "this is" / "introducing" / "you're going to love". Just an honest line a friend would write.`,
  },
